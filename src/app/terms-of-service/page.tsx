    ...
    <div className='page'>
      <div className='container'>
        ...
        <p>
          ...
          Do not continue to use PawPal if you do not agree to take all of the
          terms and conditions stated on this page.
        </p>
        <h2>License</h2>
        <p>
          Unless otherwise stated, PawPal and/or its licensors own the
          intellectual property rights for all material on PawPal. All
