    ...
    return (
      <div className="page">
            ...
            <p>
                ...
                and regulations for the use of [Your Company Name]'s App, [Your App Name],
                located at [Your App URL].
            </p>
            <p>
                By accessing this app we assume you accept these terms and conditions.
                Do not continue to use [Your App Name] if you do not agree to take all
            ...
            <p>
                ...
                [Your App Name] for your own personal use subjected to restrictions
                set in these terms and conditions.
            </p>
            <h2>User Comments</h2>
            <p>
                Parts of this app offer an opportunity for users to post and exchange
                opinions and information in certain areas of the website. [Your Company Name]
                ...
                [Your Company Name], its agents, and/or affiliates.
            </p>
            ...
            <p>
                We shall not be held responsible for any content that appears on your App.
                No link(s) should appear on any App that may be interpreted as libelous,
            ...
            <h2>Removal of links from our App</h2>
            <p>
