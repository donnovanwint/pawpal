  ...
  return (
    <div className='page'>
      <div className='container'>
        ...
        <p>
          Welcome to PawPal, the dedicated app for pet assistance. Your privacy
          is critically important to us. At PawPal, we have a few fundamental
          principles:
        </p>
        <p>
        ...
        <h2>Log Data</h2>
        <p>
          Like many app operators, we collect information that your device sends
          whenever you use our App ("Log Data"). This Log Data may include
          information such as your device's Internet Protocol ("IP") address,
          device type, operating system, the pages of our App that you visit,
